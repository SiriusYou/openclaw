...
| 2026-03-13 | D9 fixed, R6 done, R8 complete (7/7) | process_validation scope (2-member group, off-window); no_tracking | Next effect_validation needs audience scale + Tue-Thu window + tracking |
